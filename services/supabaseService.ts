...
export const fetchCustomersByBranchAndSalesPerson = async (branchId: string, salesPersonName?: string): Promise<Customer[]> => {
  ...
  try {
    ...
    const branchVariations = [
      ...
      branchId === 'uls' ? 'Ulhasnagar HO' : null,
      branchId === 'delhi' ? 'Delhi HO' : null,
      branchId === 'del' ? 'Delhi HO' : null,
      branchId === 'bangalore' ? 'Banglore HO' : null,
      branchId === 'bnglr' ? 'Banglore HO' : null,
      branchId === 'tirupur' ? 'Tirupur HO' : null,
      branchId === 'tnp' ? 'Tirupur HO' : null,
      branchId === 'ahmedabad' ? 'Ahmedabad HO' : null,
      branchId === 'ahl' ? 'Ahmedabad HO' : null,
      branchId === 'surat' ? 'Surat HO' : null,
      ...
      branchId === 'bangalore' || branchId === 'bnglr' ? 'Banglore' : null,
      branchId === 'tirupur' || branchId === 'tnp' ? 'Tirupur' : null,
